...
public class FloydWarshall {
    ...
    public static void main(String[] args){
        FloydWarshall object = new FloydWarshall("week2-5/src/main/resources/g1.txt");
        System.out.println(object.floydWarshall());

        object = new FloydWarshall("week2-5/src/main/resources/g2.txt");
        System.out.println(object.floydWarshall());

        object = new FloydWarshall("week2-5/src/main/resources/g3.txt");
        System.out.println(object.floydWarshall());
    }
}
